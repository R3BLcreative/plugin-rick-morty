...
class Plugin_Rick_Morty {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Plugin_Rick_Morty_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'plugin-rick-morty';
	 ...
	 *
	 * - Plugin_Rick_Morty_Loader. Orchestrates the hooks of the plugin.
	 * - Plugin_Rick_Morty_i18n. Defines internationalization functionality.
	 * - Plugin_Rick_Morty_Admin. Defines all hooks for the admin area.
	 * - Plugin_Rick_Morty_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Plugin_Rick_Morty_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Plugin_Rick_Morty_Loader    Orchestrates the hooks of the plugin.
	 */
